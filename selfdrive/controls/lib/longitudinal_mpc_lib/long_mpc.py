...
# Try to import custom parameters, fall back to defaults if not available
try:
  from selfdrive.controls.lib.longitudinal_mpc_lib.custom_long_params import COMFORT_BRAKE, STOP_DISTANCE
except ImportError:
  COMFORT_BRAKE = 2.5
  STOP_DISTANCE = 6.0
